      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-8 max-w-2xl animate-fade-in-up delay-100">
            I&apos;m a bookkeeper who&apos;s also a personal trainer. I know your business 
            inside out — the payment chaos, the seasonal swings, the HST headaches. 
            Let me handle the numbers while you focus on your clients.
          </p>
          ...
          <div className="mt-16 pt-8 border-t border-slate-200 animate-fade-in-up delay-400">
            <p className="text-sm text-slate-500 mb-4">Trusted by fitness professionals across the GTA</p>
